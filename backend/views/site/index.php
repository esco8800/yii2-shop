...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">Вы успешно вошли в систему управления магазином</p>

        <p><a class="btn btn-lg btn-success" href="/shop/product/index">Начать администрирование товаров</a></p>
    </div>
</div>
